      ...
      <section className="pt-8 sm:pt-12">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
            I'm <strong className="text-zinc-900 dark:text-zinc-100 font-medium">Moin Ahmad</strong>, a passionate Frontend Developer and UI/UX Designer with expertise in React, Next.js, and modern web technologies. Skilled in creating intuitive user interfaces, optimizing web performance, and delivering seamless user experiences across web and mobile platforms.
          </p>
        ...
        <section className="space-y-10">
          <div className="flex flex-col gap-6">
            {articles.slice(0, 3).map((post) => (
              <Link href={`/blog/${post.slug}`} key={post.slug} className="group relative flex flex-col items-start">
