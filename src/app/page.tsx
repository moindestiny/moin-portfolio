...
import { SOCIAL_LINKS, WORK_EXPERIENCE, BLOG_POSTS } from "@/lib/constants";
import { getProjects, getArticles } from "@/lib/db";
import {
  Github,
  Twitter,
  Linkedin,
...
const SocialIcon = ({ href, icon: Icon }: { href: string; icon: any }) => (
  <a href={href} target="_blank" rel="noreferrer" className="group -m-1 p-1">
...
const GALLERY_IMAGES = [
  "/assets/projects/fitness/fitness1.png",
  "/assets/projects/bakery/bakery1.png",
  "/assets/projects/koderoute/koderoute1.png",
  "/assets/projects/unityfusion/unityfusion1.png",
];
      ...
      <section className="pt-8 sm:pt-12">
        <div className="max-w-4xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            , a passionate Frontend Developer and UI/UX Designer with expertise
            in React, Next.js, and modern web technologies. Skilled in creating
            intuitive user interfaces, optimizing web performance, and
            delivering seamless user experiences across web and mobile
            platforms.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="space-y-10">
          ...
          <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40 bg-white dark:bg-zinc-900 shadow-sm">
                ...
                <li key={i} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link
                      ...
                      className="text-sm font-medium text-zinc-900 dark:text-zinc-100 truncate hover:text-teal-500 dark:hover:text-teal-400 transition-colors"
                    >
                      {p.title}
                    </Link>
            ...
            <Link
              href="/projects"
              className="mt-4 block text-sm text-teal-500 hover:text-teal-600 font-medium"
            >
